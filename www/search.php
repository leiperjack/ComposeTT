...
echo 'You searched for: '.$_POST["Text1"]; 
        ...
        $sqlget = "SELECT distinct clubName, nickname, founded, stadiumName FROM club, stadia, stadiumMap where city = '".trim($_POST["Text1"])."' AND club.club_id=stadiumMap.club_id and stadia.stadium_id=stadiumMap.stadium_id ";
...
<form method="POST" target="#here" action="search.php" checked="checked">
